...
if __name__ == "__main__":
    ...
    print(list(expressions_by_meaning.items())[0])
    random_expression = list(natural_languages.pop().expressions)[0]
    print(repr(random_expression.meaning))
    print(random_expression.meaning in expressions_by_meaning)
