...
if __name__ == "__main__":
    ...
    write_expressions(
        expressions_by_meaning.values(), "quantifiers/outputs/generated_expressions.yml"
    )

    with open("quantifiers/outputs/expressions_and_extensions.txt", "w") as f:
    ...
    with open("quantifiers/outputs/grammar_rules.txt", "w") as f:
        f.write(remove_class_cruft(str(quantifiers_grammar)))
