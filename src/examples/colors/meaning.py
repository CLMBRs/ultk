...
for language in expressions_by_language:
    for speaker in expressions_by_language[language]:
        ...
        for expression in expressions_by_language[language][speaker]:
            ...
            expressions.append(Expression(form=expression, meaning=Meaning(tuple([Referent(name=color) for color in expressions_by_language[language][speaker][expression]]), universe=color_universe)))
