"""Example demonstrating how to extend the objects and tools in the `altk.language` and `altk.effcomm` modules to a specific use case.
...
The `languages` file implements an extension of the fundamental ALTK language, expression, and meaning abstractions into the signaling game use case.

The `agents` file shows how to extend the basic `altk.effcomm.agent` objects to a dynamic learning agents.
